...
export function Footer() {
  ...
  return (
    <footer className="relative w-full bg-background overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 pb-16 md:pb-20 relative z-10">
        {/* Main Footer Content */}
        <motion.div
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-white/70">
              Find us next to Mega Glatt Mart in Reseda
            </p>
          </div>
          ...
          <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-[#D4AF37]/20">
            ...
            {/* Map Overlay */}
            <div className="absolute top-4 left-4 bg-background/90 backdrop-blur-sm rounded-lg px-4 py-3 border border-[#D4AF37]/30">
